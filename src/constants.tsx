...
export const TRANSLATIONS: Translations = {
  ...
  typhoon_estimation: { en: "Typhoon Intelligent Monitoring and Forecasting", zh: "台风智能监测与预报" },
  idol_viz: { en: "IDOL", zh: "IDOL" },
  cloud_pred: { en: "Energy Meteorology Services", zh: "能源气象服务" },
  rainfall_forecasting: { en: "Rainfall Intelligent Retrieval and Prediction", zh: "降雨智能反演与预测" },
  ...
  cloud_timeline: { en: "Cloud Nowcasting Timeline", zh: "云系预报时间轴" },
  past_input: { en: "Historical Observation 3h", zh: "历史观测 3 小时" },
  future_pred: { en: "Future Forecast 3h", zh: "未来预报 3 小时" },
